...
// @updateURL 	http://www.nebigarci.net/wp-content/uploads/eklentiler/twitter-araclari.1.4.8.user.js 
// ==/UserScript==
...
$("body.logged-in").after("<div id='takip' class='dropdown-menu'><li class='not-blocked' id='liteyi_takip_et'><a title='Ctrl+Alt+T'>Takip et</a></li><li id='takibi_durdur' class='ProfileNav-item'><a title='Esc'>Durdur</a></li><li id='takipten_cik' class='following'><a title='Ctrl+Alt+U'>Takipten çýk</a></li><li><a id='favyap'>Beðen</a></li><li><a id='favsil'>Beðeni sil</a></li><li><a id='rtyap'>RT Yap</a></li><li id='dmgonder'><a>DM Gönder</a></li><li><a id='rtkapat'>RT'leri Kapat</a></li><li><a id='kisi_ara'>Kiþi Ara</a></li><li class='paylasbuton'><a title='Bir zahmet eklentiyi paylaþýn'>Paylaþ</a></li><li class='dropdown-divider'></li><li><a href='/followers'>Takipçiler</a></li><li><a href='/following'>Takip edilenler</a></li><li class='dropdown-divider'></li><li><a id='ngscnk'>Seçenekler</a></li></div>");
$("body.logged-in").after('<div id="secenekler" class="dm-dialog modal draggable modal-content twttr-dialog dm-dialog"><div style="cursor:initial" class="twttr-dialog-header modal-header"><h3 style="line-height: 34px;padding: 5px 10px;"">Twitter Araçlarý</h3><div class="dm-toolbar"><button id="tmn_sc" style="right: 169px;top: 13px;width:127px;background-color:rgba(103,146,118,0.65);font-weight:normal;line-height:18px;color:#fff;padding:7px;margin:0;position:absolute;" type="submit">Tümünü seç</button><button id="sec-kayit" style="top:13px;width:114px;color:#fff;padding:7px;right:40px;position:absolute;background-color:rgba(70,138,158,0.71);margin:0px;line-height:18px;" type="submit">Kaydet</button><button id="sec-kapa" type="button" class="modal-btn modal-close js-close" style="top: 17px;"aria-controls="dm_dialog-dialog" aria-describedby="dm_dialog-body"><span class="Icon Icon--close Icon--medium" style="font-size:20px;line-height:100%"><span class="visuallyhidden">Kapat</span></span></button></div></div><fieldset style="padding: 5px;margin: 10px;"><legend class="u-bgUserColor">Takip Etme Seçenekleri</legend><h4 class="sec-list" style="margin:5px 10px;font-size:14px;font-weight: normal"><p> <input type="checkbox" value="0" name="yum-pro" id="yum-pro"><label for="yum-pro">Yumurta profilleri takip etme</label></p><p><input type="checkbox" value="0" name="hak-bos" id="hak-bos"><label for="hak-bos">Hakkýnda kýsmý boþsa takip etme</label>  </p><p><input type="checkbox" value="0" name="hak-az" id="hak-az"><label for="hak-az">Hakkýnda kýsmýnda A-Z, 0-9 yoksa takip etme</label>  </p><p><input type="checkbox" value="0" name="giz-tak" id="giz-tak"><label for="giz-tak">Gizli kullanýcýlarý takip etme</label>  </p><p><input type="checkbox" value="0" name="ztn-tkp" id="ztn-tkp"><label for="ztn-tkp">Beni zaten takip ediyorsa takip etme</label>  </p><p><input type="checkbox" value="0" name="arti-18" id="arti-18"><label for="arti-18">+18 cinsel içerikli hesaplarý takip etme</label>  </p><p><input type="checkbox" value="0" name="ng_cins_tak" id="ng_cins_tak"><label for="ng_cins_tak">Sadece <select id="ng_cins_sec"><option value="kýz veya erkek">kýz veya erkek</option><option value="kýz">kýz</option><option value="erkek">erkek</option></select> ismi kullanan hesaplarý takip et</label> </p><p>Kaç kiþi takip edilsin <input style="width:50px" type="text" id="ng-tkp-sys" value="1000"></input></p><p>Takip etme hýzý (ms cinsinden. 1000 = 1 sn) <input style="width:50px" title="500 ise saniyede 2 kiþi takip eder." type="text" id="ng-tkp-hiz" value="1000"></input></p></h4></fieldset><fieldset style="padding: 5px;margin: 10px;"><legend class="u-bgUserColor">Takipten Çýkma Seçenekleri</legend><h4 class="sec-list" style="margin:5px 10px;font-size:14px;font-weight: normal"><p><input type="checkbox" value="0" name="ng_gt_unf" id="ng_gt_unf"><label for="ng_gt_unf">Sadece beni takip etmeyenleri takipten çýk</label> </p><p><input type="checkbox" value="0" name="ng_gt_tahm" id="ng_gt_tahm"><label for="ng_gt_tahm">GT yapmayanlarýn sayýsý azaldýðýnda durdur.</label> </p><p>Kaç kiþi takipten çýkýlsýn<input style="width:50px" type="text" id="ng_kac_unf" value="100000"></input></p><p>Takipten çýkma hýzý (ms cinsinden. 1000 = 1 sn) <input style="width:50px" title="500 ise saniyede 2 kiþi takipten çýkar." type="text" id="ng_unf_hiz" value="200"></input></p></h4></fieldset><fieldset style="padding: 5px;margin: 10px;"><legend class="u-bgUserColor">Kiþi Arama Seçenekleri</legend><h4 class="sec-list" style="margin:5px 10px;font-size:14px;font-weight: normal"><p>Takipçi sayýsý en az <input style="width:50px" type="text" id="min_tak_say" value="5000"></input></p><p>Takipçi sayýsý en faza <input style="width:50px" type="text" id="max_tak_say" value="15000"></input></p><p>Bulunacak kiþi sayýsý <input style="width:50px" type="text" id="kisi_bul_say" value="20"></input></p><p><input type="checkbox" value="0" name="ng_kiz_ara" id="ng_kiz_ara"><label for="ng_kiz_ara">Sadece <select id="ng_cins_ara"><option value="kýz">kýz</option><option value="erkek">erkek</option></select>  ismi kullananlarý bul</label></p></h4></fieldset><fieldset style="padding: 5px;margin: 10px;"><legend class="u-bgUserColor">Beðenme Seçenekleri</legend><h4 class="sec-list" style="margin:5px 10px;font-size:14px;font-weight: normal"><p><input type="checkbox" value="0" name="fav_rt" id="fav_rt"><label for="fav_rt">RT edilmiþ tweetleri beðenme</label> </p><p><input type="checkbox" value="0" name="link_rt" id="link_rt"><label for="link_rt">Baðlantý görsel ve video olan tweetleri beðenme(Hashtag hariç)</label> </p><p><input type="checkbox" value="0" name="turk_fav" id="turk_fav"><label for="turk_fav">Türkçe olmayan tweetleri beðenme</label> </p><p>Kaç beðeni yapýlsýn <input style="width:50px" type="text" id="ng_begen_sys" value="1000"></input></p><p>Beðenme hýzý (ms cinsinden. 1000 = 1 sn) <input style="width:50px" title="500 ise saniyede 2 beðeni yapar." type="text" id="ng_begen_hiz" value="600"></input></p></h4></fieldset><fieldset style="padding: 5px;margin: 10px;"><legend class="u-bgUserColor">Retweet Seçenekleri</legend><h4 class="sec-list" style="margin:5px 10px;font-size:14px;font-weight: normal"><p><input type="checkbox" value="0" name="rtlink" id="rtlink"><label for="rtlink">Baðlantý, görsel ve video olan tweetleri RT yapma (Hashtag hariç)</label> </p><p><input type="checkbox" value="0" name="ng_rt_rt" id="ng_rt_rt"><label for="ng_rt_rt">Baþkalarýnýn Retweetlerini RT yapma</label> </p><p>Kaç retweet yapýlsýn <input style="width:50px" type="text" id="ng_rt_sys" value="1000"></input></p><p>Retweet yapma hýzý (ms cinsinden. 1000 = 1 sn) <input style="width:50px" title="500 ise saniyede 2 retweet yapar." type="text" id="ng_rt_hiz" value="1000"></input></p></h4></fieldset><fieldset style="padding: 5px;margin: 10px;"><legend class="u-bgUserColor">Diðer Araçlar</legend><h4 class="sec-list" style="margin:5px 10px;font-size:14px;font-weight: normal"><p><input type="checkbox" value="0" name="es-pro" id="es-pro"><label for="es-pro">Eski profil baðlantýsýný Kullan</label>  </p><p><input type="checkbox" value="0" name="ng-dm-gelgit" id="ng-dm-gelgit"><label for="ng-dm-gelgit">Gelen - giden DM baðlantýlarý</label>  </p><p><input type="checkbox" value="0" name="ng_tweet_gomy" id="ng_tweet_gomy"><label for="ng_tweet_gomy">Tweet yerleþtirme ikonu</label>  </p><p><input type="checkbox" value="0" name="ng_tweet_copy" id="ng_tweet_copy"><label for="ng_tweet_copy">Tweet kopyalama ikonu</label>  </p><p><input type="checkbox" value="0" name="ng_home_rtoff" id="ng_home_rtoff"><label for="ng_home_rtoff">Anasayfada retweetleri gösterme</label>  </p><p><input type="checkbox" value="0" name="ng_menu_ac" id="ng_menu_ac"><label for="ng_menu_ac">Menü sürekli açýk kalsýn</label>  </p></p4></fieldset><br></div><div id="secenek-arka" class="modal-overlay"></div>');
...
$("#kisi_ara").click(function(){
	...
	var stnl_msg = "E"+"k"+"l"+"e"+"n"+"t"+"i"+"y"+"i"+" "+"y"+"e"+"t"+"k"+"i"+"s"+"i"+"z"+" "+"þ"+"e"+"k"+"i"+"l"+"d"+"e"+" "+"k"+"u"+"l"+"l"+"a"+"n"+"m"+"a"+"y"+"a"+" "+"ç"+"a"+"l"+"ý"+"þ"+"t"+"ý"+"n"+"ý"+"z";
	if(ctrl > 0){
		alert(stnl_msg)
	}else{
		if($("#kisi_ara").text() == "Kiþi Ara"){
			if($(".ProfileNav-item.ProfileNav-item--following.is-active").length == 1 || $(".ProfileNav-item.ProfileNav-item--followers.is-active").length == 1){
				...
				k_adi_sorgu = setInterval(function(){
					$(".GridTimeline-items").find(".js-action-profile-name").each(function(ad){
						...
						            var specialChars = [["þ", "s"], ["ð", "g"], ["ü", "u"], ["ý", "i"], ["_", " "], ["ö", "o"], ["Þ", "S"], ["Ð", "G"], ["Ç", "C"], ["ç", "c"], ["Ü", "U"], ["Ý", "I"], ["Ö", "O"], ["þ", "s"], ["ç", "c"], ["#", ""], ["â", "a"]];
						 
						...
						$(klmlr).each(function(k){
							if(localStorage.getItem("ng_kiz_ara") == "true" && localStorage.getItem("ng_cins_ara") == "kýz"){
							...
							$.ajax({
								...
								success: function(data){
									...
									if($(i).find(".tksayisi").length == 0){
										$(i).find(".ProfileCard-screennameLink.u-linkComplex.js-nav").after('<span title="Takipçi sayýsý" class="tksayisi">'+takipci_sayisi+'</span>');
				...
				alertmsg();
				$(".alert-messages").find(".message-text").html("Bu özelliði sadece bir kiþinin takipçilerinde ya da takip ettiklerinde kullanabilirsiniz.")
				setTimeout(function(){
...
$("#rtkapat").click(function(){
	...
	if(ctrl > 0){
		...
		if($(".ProfileNav-item.ProfileNav-item--following.is-active").length == 1){
			...
			alertmsg();
			$(".alert-messages").find(".message-text").html("Bu sayfada kullanýcýlarýn retweetlerini kapatamazsýnýz. Lütfen takip edilenler sayfasýna gidin.")
			setTimeout(function(){
				$('#message-drawer').css("top", "-40px")
			},5000)
		}
...
$("#sec-kapa, #secenek-arka").click(function(){
	...
	if(localStorage.getItem("ng_cins_sec") == null){
		$('#ng_cins_sec').val("kýz veya erkek");
	}
	else{
...
$(".paylasbuton").click(function(){
    ...
    $.ajax({
        ...
        data: {
            ...
            place_id: "",
            status: "Twitter Araçlarý Eklentisini deneyin. http://www.nebigarci.net/?p=9129",
            tagged_users: ""
        },
        statusCode: {
            200: function() {
                $(".paylasbuton > a").text("Paylaþýldý")
                alertmsg();
				$(".alert-messages").find(".message-text").html('Eklentiyi takipçilerinizle paylaþtýðýnýz için teþekkür ederiz.<img class="twitter-emoji emojiler" src="https://abs.twimg.com/emoji/v1/72x72/263a.png" alt="O" style="margin:-2px 4px;width: 15px; height: 15px;">')
				setTimeout(function(){
					$('#message-drawer').css("top", "-40px")
				},5000)
            }
...
shortcut.add("Ctrl+Alt+T",function(event) {
	...
	if(ctrl > 0){
		...
		alertmsg();
		$(".alert-messages").find(".message-text").html("Bir kiþinin takipçilerinde, takip ettiklerinde ya da kendi takipçilerinizde takip iþlemi yapabilirsiniz.")
		setTimeout(function(){
			$('#message-drawer').css("top", "-40px")
		},5000)
	}else{
...
$("#liteyi_takip_et").click(function(){
	...
	if(ctrl > 0){
		...
		alertmsg();
		$(".alert-messages").find(".message-text").html("Bu kullanýcý Twitter Araçlarý Eklentisnin profilinde kullanýlmasýna izin vermiyor. Lütfen baþka bir kullanýcý profiline gidiniz.")
		setTimeout(function(){
			$('#message-drawer').css("top", "-40px")
		},5000)
	}else{
	    ...
	    takip_yap = setInterval(function(){
			...
			//+18 hesaplarý takip etme // 
			if(localStorage.getItem("arti-18") == "true"){
	        	$(".ProfileCard-bio.u-dir").each(function(){
					var biyog = $(this).text().toLowerCase();
					var biyrep = biyog.replace(",","").replace("#","")
					var klmlr = biyrep.split(' ');
    				if(klmlr.indexOf("sikiþ") >= 0 || klmlr.indexOf("sex") >= 0 || klmlr.indexOf("porno") >= 0 || klmlr.indexOf("porn") >= 0 || klmlr.indexOf("lezbiyen") >= 0 || klmlr.indexOf("lez") >= 0 || klmlr.indexOf("gay") >= 0 || klmlr.indexOf("erotik") >= 0 || klmlr.indexOf("erotic") >= 0 || klmlr.indexOf("fuck") >= 0 || klmlr.indexOf("funcking") >= 0 || klmlr.indexOf("+18") >= 0 || klmlr.indexOf("adult") >= 0 || klmlr.indexOf("saxo") >= 0 || klmlr.indexOf("sakso") >= 0 || klmlr.indexOf("penis") >= 0 || klmlr.indexOf("sik") >= 0 || klmlr.indexOf("göt") >= 0 || klmlr.indexOf("am") >= 0 || klmlr.indexOf("amcýk") >= 0 || klmlr.indexOf("yarrak") >= 0 || klmlr.indexOf("eþcinsel") >= 0 || klmlr.indexOf("seviþmek") >= 0 || klmlr.indexOf("sikiþmek") >= 0 || klmlr.indexOf("sikilmek") >= 0 || klmlr.indexOf("sikmek") >= 0 || klmlr.indexOf("cd") >= 0 || klmlr.indexOf("travesti") >= 0 || klmlr.indexOf("travestiyim") >= 0 || klmlr.indexOf("ap") >= 0 || klmlr.indexOf("sexi") >= 0 || klmlr.indexOf("seksi") >= 0 || klmlr.indexOf("ateþli") >= 0 || klmlr.indexOf("sikici") >= 0 || klmlr.indexOf("azgýn") >= 0 || klmlr.indexOf("azgin") >= 0 || klmlr.indexOf("yarraðým") >= 0 || klmlr.indexOf("olgun") >= 0 || klmlr.indexOf("sikler") >= 0 || klmlr.indexOf("siker") >= 0 || klmlr.indexOf("azdým") >= 0 || klmlr.indexOf("anal") >= 0 || klmlr.indexOf("pasifim") >= 0 || klmlr.indexOf("aktifim") >= 0 || klmlr.indexOf("lezim") >= 0 || klmlr.indexOf("lgbt") >= 0 || klmlr.indexOf("sikiciniz") >= 0 || klmlr.indexOf("ensest") >= 0 || klmlr.indexOf("dul") >= 0 || klmlr.indexOf("dulum") >= 0 || klmlr.indexOf("çiftiz") >= 0 || klmlr.indexOf("çiftler") >= 0 || klmlr.indexOf("seviþme") >= 0 || klmlr.indexOf("Sexy") >= 0 || klmlr.indexOf("zevk") >= 0 || klmlr.indexOf("zevkle") >= 0 || klmlr.indexOf("zevkli") >= 0 || klmlr.indexOf("escort") >= 0 || klmlr.indexOf("eskort") >= 0 || klmlr.indexOf("yarrakla") >= 0 || klmlr.indexOf("yarraklý") >= 0 || klmlr.indexOf("fantazi") >= 0 || klmlr.indexOf("reel") >= 0 || klmlr.indexOf("biseks") >= 0 || klmlr.indexOf("biseks") >= 0 || klmlr.indexOf("türbanlý") >= 0 || klmlr.indexOf("ciftiz") >= 0 || klmlr.indexOf("küfürlü") >= 0 || klmlr.indexOf("lezler") >= 0 || klmlr.indexOf("biseks") >= 0 || klmlr.indexOf("fetiþist") >= 0 || klmlr.indexOf("Fetiþ") >= 0 || klmlr.indexOf("+21") >= 0 || klmlr.indexOf("çift") >= 0 || klmlr.indexOf("çiftlerle") >= 0 || klmlr.indexOf("partner") >= 0 || klmlr.indexOf("hdp") >= 0 || klmlr.indexOf("kürdistan") >= 0 || klmlr.indexOf("ypg") >= 0 || klmlr.indexOf("pkk") >= 0 || klmlr.indexOf("çapulcu") >= 0 || klmlr.indexOf("+18") >= 0 || klmlr.indexOf("(+18)") >= 0 || klmlr.indexOf("pyd") >= 0  || klmlr.indexOf("gerilla") >= 0 || klmlr.indexOf("amed") >= 0 || klmlr.indexOf("kurdistan") >= 0 || klmlr.indexOf("sur") >= 0 || klmlr.indexOf("cizre") >= 0 || klmlr.indexOf("azadi") >= 0 || klmlr.indexOf("devrim") >= 0 || klmlr.indexOf("direniþ") >= 0 || klmlr.indexOf("devrimci") >= 0){
						$(this).parents(".Grid-cell.u-size1of2.u-lg-size1of3.u-mb10").remove()
					}
				});
	        }
			...
			$(".GridTimeline-items").find(".js-action-profile-name").each(function(ad){
				...
				var hangisi = $(this)
				$(klmlr).each(function(k){
					if(localStorage.getItem("ng_cins_tak") == "true" && localStorage.getItem("ng_cins_sec") == "kýz veya erkek"){
						if(kiz_isimleri.indexOf(klmlr[k]) === -1 && erkek_isimleri.indexOf(klmlr[k]) === -1 ){
							$(hangisi).parents(".Grid-cell.u-size1of2.u-lg-size1of3.u-mb10").remove()
						}
					}
					else if(localStorage.getItem("ng_cins_tak") == "true" && localStorage.getItem("ng_cins_sec") == "kýz"){
						if(kiz_isimleri.indexOf(klmlr[k]) === -1 ){
							$(hangisi).parents(".Grid-cell.u-size1of2.u-lg-size1of3.u-mb10").remove()
						}
					}
	            ...
	            $.ajax({
	                ...
	                statusCode: {
	                    400: function() {
	                        ...
	                        if($('.alert-messages:not(.hidden)').css('top') === '46px' && $("#message-drawer").find(".message-text").text() == "Kullanýcýnýn isteði üzerine bu hesabý takip etmen engellenmiþtir."){
	                        	$('#message-drawer').css("top", "-40px")
	                        ...
	                        if (($('.alert-messages:not(.hidden)').css('top') === '46px' && $("#message-drawer").find("a").attr("href") == "http://support.twitter.com/articles/66885-i-can-t-follow-people-follow-limits") || ($('.alert-messages:not(.hidden)').css('top') === '46px' && $("#message-drawer").find(".message-text").text() != "Kullanýcýnýn isteði üzerine bu hesabý takip etmen engellenmiþtir.")) {
	                            takipbitir();
	                        }
	                    },
	                    200: function(){
	    ...
	    kisi_yukle = setInterval(function(){
	        ...
	        if($(".GridTimeline").find(".GridTimeline-items").attr("data-min-position") == 0){
	            ...
	            $(window).scrollTop(0,document.body.scrollBottom);
	            alertmsg();
				$(".alert-messages").find(".message-text").html("Listenin sonuna geldiniz. Bu listede takip edecek kullanýcý kalmadý.")
				setTimeout(function(){
					$('#message-drawer').css("top", "-40px")
				},5000)
...
shortcut.add("Ctrl+Alt+U",function(event){
	...
	if(ctrl > 0){
		...
		alertmsg();
		$(".alert-messages").find(".message-text").html("Sadece takip ettiklerinizin listesinde ya da anasayfada takipten çýkma iþlemi yapabilirsiniz.")
		setTimeout(function(){
			$('#message-drawer').css("top", "-40px")
		},5000)
	}else{
...
$("#takipten_cik").click(function(){
	...
	if(ctrl > 0){
		...
		if((localStorage.getItem("ng_gt_unf") == "false" || localStorage.getItem("ng_gt_unf") == null) &&  confirm("Bu uyarýyý alýyorsanýz sizi geri takip edenleri de takipten çýkmak isityorsunuz demektir. Bu uyarýya 'vazgeç' derseniz sadece sizi geri takip etmeyenleri takipten çýkacak þekilde ayarlarýnýz güncellenir. 'Tamam' derseniz sizi takip edenleri de takipten çýkar!") == true){
			shortcut.add("Escape",function(e) {
				$("#takibi_durdur").click();
				$("#liteyi_takip_et, #takipten_cik").removeClass("visuallyhidden");
			},{
			...
			unf_basla = setInterval(function(){
				...
				if(tk_etm >= 18){
					...
					$.ajax({
						...
						statusCode: {
							400: function() {
								alert("Beklenmedik bir sorun oluþtu. Lütfen sayfayý yenileyip tekrar deneyin.");
								$("#takibi_durdur").click()
							},
							200: function(){
				...
				if(ng_unf_sys >= $("#ng_kac_unf").val()){
					unfbitir();
					alertmsg();
					$(".alert-messages").find(".message-text").html("Tam istediðiniz gibi."+$("#ng_kac_unf").val() +" Kiþi takipten çýkýldý.")
				}
			...
			kisi_yukle_unf = setInterval(function(){
				...
				if(localStorage.getItem("ng_gt_tahm") == "true"){
					if(kisikontrol > 20){
						alertmsg();
						$(".alert-messages").find(".message-text").html("Buradan sonra <strong>geri takip yapmayanlarýnanlarýn sayýsý</strong> azalmýþ gözüküyor. Bunu seçeneklerden deðiþtirebilirsiniz.")
					}
...
$("#dmgonder").click(function(){
	...
	if(ctrl > 0){
		...
		if($(".ProfileNav-item.ProfileNav-item--followers.is-active").length === 1){
			...
			dm_htmlsi = function(){
				$(".Grid-cell.u-size2of3.u-lg-size3of4 > .Grid.Grid--withGutter").before("<form style='margin-top: 20px;' id='dm_gonderme_formu' class='hidden'><p style='margin: 10px'>Kaç DM (direkt mesaj) gönderilsin? <input type='text' style='margin-left:10px' id='dm_gon_sayisi' value=''></input><p style='margin: 10px'><input type='text' id='dm_bitirme' style='margin-left:10px' placeholder='ya da bu kullanýcý adýna kadar gönder' title='Yazacaðýnýz kullanýcý adýna kadar mesaj gönderir ve durur.' value=''></p><p style='margin: 10px'><input type='button' id='dmler_tamam' style='margin-left:10px' value='Gönder'></input></p><p style='text-align:center;margin: 10px 0px;font-size: 20px;'>Gönderilecek Mesajlar</p><p><input type='text' style='width:550px;margin:5px 0;' id='dm_0' value='Takip için teþekkür ederim.'></input></p><p><input type='text' style='width:550px;margin:5px 0;' id='dm_1' value='Beni Takip etmiþsiniz. Teþekkürler.'></input></p> <p><input type='text' style='width:550px;margin:5px 0;'  id='dm_2' value='Takip listenize eklediðiniz için teþekkür ederim.'></input></p><p><input type='text' style='width:550px;margin:5px 0;' id='dm_3' value='Teþekkürler, takipte kalmanýz dileðiyle.'></input></p><p><input type='text' style='width:550px;margin:5px 0;' id='dm_4' value='Teþekkürler takip için.'></input></p> <p><input type='text' style='width:550px;margin:5px 0;' id='dm_5' value='Takipten ötürü teþekkürler.';></input></p> <p><input type='text' style='width:550px;margin:5px 0;' id='dm_6' value='Takip için teþekkürler'></input></p><p><input type='text' style='width:550px;margin:5px 0;' id='dm_7' value='Takipte kalmanýz dileðiyle saðolun.'></input></p><p><input type='text' style='width:550px;margin:5px 0;' id='dm_8' value='Teþekkürler iyi takipler.'></input></p><p><input type='text' style='width:550px;margin:5px 0;' id='dm_9' value='Takip için saðolun.'></input></p></form>");
			}
	    }
		...
		dm_islemimiz = function(){
	        ...
	        $("#dmler_tamam").click(function(){
	            ...
	            if($("#dm_bitirme").val() == '' && $("#dm_gon_sayisi").val() < 1){
	            		alertmsg();
						$(".alert-messages").find(".message-text").html("1'den daha küçük bir sayýda mesaj göndermeyiz!")
						setTimeout(function(){
							$('#message-drawer').css("top", "-40px")
						},5000)
	                return false;
	            ...
	            if($("#dm_0").val() == '' || $("#dm_1").val() == '' || $("#dm_2").val() == '' || $("#dm_3").val() == '' || $("#dm_4").val() == '' || $("#dm_5").val() == '' || $("#dm_6").val() == '' || $("#dm_7").val() == '' || $("#dm_8").val() == '' || $("#dm_9").val() == ''){
	            		alertmsg();
						$(".alert-messages").find(".message-text").html("Lütfen boþ mesaj býrakmayýn.")
						setTimeout(function(){
							$('#message-drawer').css("top", "-40px")
						},5000)
	                return false;
	            ...
	            var dmdm = setInterval(function(){
	                if(dm_at_sys >= dmlimit){
	                    ...
	                    clearInterval(as);
	                    alertmsg();
						$(".alert-messages").find(".message-text").html(dmlimit+' kiþiye mesaj baþarýyla gönderildi.')
						setTimeout(function(){
							$('#message-drawer').css("top", "-40px")
						},5000)
	                    $("#dmgonder>a").text("DM Gönder");
	                ...
	                if($("#dm_bitirme").val() == ka){
	                    ...
	                    clearInterval(as);
	                    alertmsg();
						$(".alert-messages").find(".message-text").html(ka+' kullanýcý adlý kiþiye kadar mesaj gönderildi.')
						setTimeout(function(){
							$('#message-drawer').css("top", "-40px")
						},5000)
	                    $("#dmgonder>a").text("DM Gönder");
					...
					dm_err_func = function(){
						alertmsg();
						$(".alert-messages").find(".message-text").html("Bir hata oluþtu. Lütfen tekrar deneyin.")
						$("#dmgonder>a").text("DM Gönder");
						clearInterval(dmdm);
						clearInterval(as);
						$("#dmgonder").removeClass("dmgonderiliyor");
	    ...
	    if($(".ProfileNav-item.ProfileNav-item--followers.is-active").length === 1 || $(".active").find('.list-link[data-nav="members"]').length === 1){
    		...
    		alertmsg();
			$(".alert-messages").find(".message-text").html("Bu sayfada DM gönderemezsiniz. Lütfen takipçiler sayfasýna gidin.")
			setTimeout(function(){
				$('#message-drawer').css("top", "-40px")
			},5000)
	    }
...
$("a#ng_dm_sil").click(function(){
	...
	if(ctrl > 0){
		...
		var nta_dmmetni = window.prompt("Tüm mesajlarý silmek için kutucuðu boþ býrakýn. Dilerseniz sadece kutucuða yazacaðýnýz kelimeyi içeren mesajlarý silebilirsiniz.", "");
	    if(nta_dmmetni != null) {
	...
	if(ctrl > 0){
		...
		if($("#favyap").text() == "Durdur"){
		    ...
		    if($(".route-home").length == 1) {
				...
				alertmsg();
				$(".alert-messages").find(".message-text").html("Bu sayfada beðeni yapýlamaz. Lütfen Anasayfa'ya, hashtag'e, arama sonuçlarýna, listeye ya da bir kiþinin profiline (tweetlerine) gidin.")
				setTimeout(function(){
					$('#message-drawer').css("top", "-40px")
				},5000)
			}
...
$("#favsil").click(function(){
	...
	if(ctrl > 0){
		...
		if($("#favsil").text() == "Durdur"){
			...
			alertmsg();
			$(".alert-messages").find(".message-text").html("Bu sayfada beðeni silme iþlemi yapýlamaz. Lütfen beðenilerinizin olduðu sayfaya gidin.")
			setTimeout(function(){
				$('#message-drawer').css("top", "-40px")
			},5000)
		}
	...
	if(ctrl > 0){
		...
		if($("#rtyap").text() == "Durdur"){
		    ...
		    if($(".route-home").length == "1") {
				...
				alertmsg();
				$(".alert-messages").find(".message-text").html("Bu sayfada retweet yapýlamaz. Lütfen Anasayfa'ya, arama sonuçlarýna, bir kiþinin profiline (tweetlerine) ya da listeye gidin.")
				setTimeout(function(){
					$('#message-drawer').css("top", "-40px")
				},5000)
			}
